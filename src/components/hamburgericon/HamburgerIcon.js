        ...
        >
          ...
          <Offcanvas.Body>
            <Nav className="justify-content-end flex-grow-1 pe-3">
             ...
             (<Nav.Link className="list-item"href="#action1" key={i} listItem={listitem} onClick={() =>{category(listitem)}}>{listitem}</Nav.Link>)
             )}
            </Nav>
          ...
          <div className="devName">
            <div className="name"><span>D</span>eveloped by-:<b><span>J</span>atin <span>P</span>andey</b></div>
            <hr />
